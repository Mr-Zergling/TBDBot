...
class EmojiCog(commands.Cog):
    ...
    async def count(self, ctx):
        ...
        async with message.channel.typing():
            ...
            overall.seek(0)
            await self.bot.reply(ctx, "Here are your counts by date and channel!",
                                 file=discord.File(date_and_channel,
                                                   "emojis_by_date_and_channel.csv"))
            await self.bot.reply(ctx, "And your overall counts", file=discord.File(overall, "overall.csv"))
